...
public class BluetoothThread extends Thread {
     ...
     *
     */
    public BluetoothThread(Device device, Handler logHandler, Handler handler) {

        this.address = device.Key.toUpperCase();
    ...
    {
        {
            ...
            message.obj = "Attempting connection to " + mDevice.Name;
        ...
        {
            Message message = new Message();
            message.obj = "Connected successfully to " + mDevice.Name;
            logHandler.sendMessage(message);
        }
    ...
    public void run() {
        ...
        catch (Exception e)
        {
            {
                Message message = new Message();
                message.obj = "Failed to connect to " + mDevice.Name;
                logHandler.sendMessage(message);
            }
        ...
        while (!this.isInterrupted()) {
            ...
            if ((inStream == null) || (outStream == null))
            {
                {
                    Message message = new Message();
                    message.obj = "Lost bluetooth connection!";
                    logHandler.sendMessage(message);
                }
